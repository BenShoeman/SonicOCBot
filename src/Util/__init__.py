"""
This module contains various utilities used throughout the app.

The specific submodules are as follows:
...
- **src.Util.HTML2ImageStrategy**: Strategies to convert HTML to images.
